...
@Component({
  selector: 'app-politicas-de-productos',
  templateUrl: './politicas-de-productos.component.html',
  styleUrls: ['./politicas-de-productos.component.css']
})
export class PoliticasDeProductosComponent implements OnInit {
  buscar:string=""
  usuario:string="";
